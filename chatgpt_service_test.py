...
class ChatGPTServiceTest(TestCase):
    ...
    # I couldn't build a fake Response object with the json response
    @responses.activate
    def test_returns_a_response_when_asking_a_question(self):
        json = {'id': 'chatcmpl-80rL3miP00BIbi4JVueVU16BYyQkv', 'object': 'chat.completion', 'created': 1695215725,
